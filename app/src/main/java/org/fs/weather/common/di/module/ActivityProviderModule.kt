...
class ActivityProviderModule {
  ...
  @ForActivity @Provides fun provideDailyForecastDataSet(): ObservableList<DailyForecast> = ObservableList()

  @ForActivity @Provides fun provideHourlyForecastDataSet(): ObservableList<HourlyForecast> = ObservableList()
}